...
mainCyclist.setCollider("rectangle",180,180,mainCyclist.x,mainCyclist.y)
...
function draw() {
  ...
  text("Use the left and right arrow keys to move the camera!",50,30)
  ...
  //to move the camera to right
  if(keyDown("right")){
    camera.x=camera.x+5
  }

  //to move camera to left
if(keyDown("left")){
  camera.x=camera.x-5
}
